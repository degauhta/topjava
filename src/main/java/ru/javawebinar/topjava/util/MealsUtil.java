...
public class MealsUtil {
    public static final List<Meal> TEST_MEALS = Arrays.asList(
    ...
    public static void main(String[] args) {
        List<MealWithExceed> mealsWithExceeded = getFilteredWithExceeded(TEST_MEALS, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
        mealsWithExceeded.forEach(System.out::println);

        System.out.println(getFilteredWithExceededByCycle(TEST_MEALS, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
        System.out.println(getFilteredWithExceededInOnePass(TEST_MEALS, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
        System.out.println(getFilteredWithExceededInOnePass2(TEST_MEALS, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
    }
